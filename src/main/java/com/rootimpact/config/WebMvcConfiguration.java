    ...
    public WebMvcConfigurer corsConfigurer() {
        return new WebMvcConfigurer() {
            ...
            public void addCorsMappings(CorsRegistry registry) {
                registry.addMapping("/**")
//                        .allowedOrigins("https://bloom-six-dusky.vercel.app", "https://localhost:3000", "https://bloom-six-dusky.vercel.app", "http://localhost:3000", "https://bloom3.site")  // 특정 domain 허용.
                        .allowedOrigins("*")  // 특정 domain 허용.
