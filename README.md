...
- 전라도 특산물 10개를 가상의 주식회사로 모델링했습니다. 기온과 강수량, 수확량에 따라 주가에 영향을 받습니다. 
- 초기 자본 10,000,000원으로 매수/매도가 가능하며, 수익률에 따라 사용자의 해파리 캐릭터가 성장합니다.

#### 2. 해파리

- 모의주식 수익률에 따라 경험치를 얻거나, 경제 퀴즈를 해결하여 단계에 따른 경험치를 얻습니다.
...
- 지방 은행의 생활 밀착형 금융 플랫폼 및 지역 온라인 농수산몰과 제휴하여, 사회 공헌 활동에 기여할 수 있습니다. (확장성)
- 실시간 변동 반영을 위해 오차 범위 ±2% 내에서 가격 조정 및 원화 기준으로 가격을 반올림했습니다.
