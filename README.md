...
- 전라도 특산물 10개를 가상의 주식회사로 모델링하였습니다. 기온과 강수량, 수확량에 따라 주가에 영향을 받습니다. 
- 초기 자본 10,000,000원으로 매수/매도가 가능하며, 수익률에 따라 사용자의 해파리 캐릭터가 성장합니다.

### 2. 해파리

- 모의주식 수익률에 따라 경험치를 얻거나, 금융 퀴즈를 해결하며 단계에 따른 경험치를 얻습니다.
- 경험치가 특정 수치에 도달할 때마다 외형(크기, 색깔)이 변합니다.

<br>

### 🔋 기대 효과
- 수도권에 비해 금융 교육 기회가 열악한 환경의 지방 청소년들에게 재미있는 교육을 제공합니다.
