...
> Google.org가 후원하는 지역 인재 기반 해커톤 - 지역 사회 발전을 위한 솔루션 개발
...
- 전라도 특산물 10개를 가상의 주식 회사로 모델링했습니다. 기온, 강수량, 수확량에 따라 주가에 영향을 받습니다. 
- 초기 자본 10,000,000원으로 매수/매도가 가능하며, 수익률에 따라 사용자의 해파리 캐릭터가 성장합니다.

#### 2. 해파리

- 모의 주식 수익률에 따라 경험치를 얻거나, 경제 퀴즈를 해결하여 단계에 따른 경험치를 얻습니다.
- 경험치가 특정 수치에 도달할 때마다 외형(크기, 색깔)이 변합니다.

<br>

### 🔋 기대 효과
- 수도권에 비해 경제 교육 기회가 열악한 환경의 지방 청소년들에게 재미있는 경제 교육을 제공합니다.
- 청소년들에게 기온, 강수량, 수확량, 제철 시기 등 지역 농수산물에 대한 관심을 높입니다.
- 지방 은행의 생활 밀착형 금융 플랫폼 및 지역 온라인 농수산몰과 제휴하여, 사회 공헌 활동에 기여할 수 있습니다. (확장성)
...
### 홈화면
경제 교육 활동으로 얻는 포인트로 성장하는 나의 해파리를 확인할 수 있습니다. 
<br>
...
#### 📊 원하는 기업의 실시간 주가 차트
아래의 예시처럼 특정 기업의 실시간 주가 변동을 확인할 수 있습니다.
...
#### 😋 주식 현황 확인
나의 전체 주식 현황 및 상세 현황에 대해 확인할 수 있습니다.
| 전체 주식 현황                                                                                                                                                                                                |                                                                                                상세 현황                                                                                          |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
...
- 결측치가 많은 강수량 데이터의 경우 선형 보간법을 이용하여 데이터 청소년들에게 기온, 강수량, 수확량, 제철 시기 등 지역 농수산물에 대한 관심을 높입니다.
- 실시간 변동을 반영하기 위해 오차 범위 ±2% 내에서 가격 조정 및 원화 기준으로 가격을 반올림했습니다.

- 활용 데이터
  | 데이터명 | 기준 | 출처 | 링크 |
  |:------:|:------:|:------:|:------:|
  | 강수량분석 | 2024.01 - 2024.12 / 전북 전주시 | 기상청 기상자료개방포털 | https://data.kma.go.kr/stcs/grnd/grndRnList.do?pgmNo=69 |
  | 기온분석 | 2024.01 - 2024.12 / 전북 전주시 | 기상청 기상자료개방포털 |  https://data.kma.go.kr/stcs/grnd/grndTaList.do?pgmNo=70 |
